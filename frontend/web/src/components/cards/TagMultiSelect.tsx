...
export function TagMultiSelect({ tags, selectedTagIds, onToggle, onTagCreated }: TagMultiSelectProps) {
  ...
  return (
    <div className="tag-multi-select">
      <div className="tag-multi-select-pick">
      ...
      <div className="tag-multi-select-create">
        <Input
          value={newTagName}
          ...
          placeholder="新建标签"
          aria-label="新建标签"
          className="h-[2.375rem] min-w-0 flex-1 py-0 text-xs"
        />
        <Button
          type="button"
          variant="ghost"
          ...
          aria-label="添加标签"
          className="h-[2.375rem] shrink-0 px-2 sm:px-2.5"
        >
          <Plus className="h-3.5 w-3.5" />
          <span className="tag-multi-select-create-label">添加</span>
        </Button>
      </div>
    </div>
  )
